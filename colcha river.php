...
<body>
    ...
    <section class="py-5 text-center inicio">
        <div>
            <div class="col-lg-6 col-md-8 mx-auto informa">
                ...
                <br>
                <h2 class="fw-light">Gabriela Plata</h2>
            </div>
        </div>
    </section>
    ...
    <section class="producto" style="margin-left: 12%">
        <img src="https://http2.mlstatic.com/D_NQ_NP_691552-MLA52250719600_112022-O.webp" style="width: 30%; height: 40%" class="imagen-product">
        <div class="info-product" style="margin: 20px">
            <h2>Colchita del river</h2>
            <br>
