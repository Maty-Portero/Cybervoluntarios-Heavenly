...
<body>
            ...
            <div class="col-lg-6 col-md-8 mx-auto informa">
                <center>
                    <div class="imagen-circular">
                        <img src="https://bolavip.com/export/sites/bolavip/img/2022/08/28/meme-leclerc-ferrari-9_crop1661724891723.jpg_792370018.jpg" alt="Imagen">
                    </div>
                </center>
                <br>
                <h2 class="fw-light">Alberto Macri</h2>
            </div>
        </div>
    </section>
    ...
    <section class="producto" style="margin-left: 12%">
        <img src="https://m.media-amazon.com/images/I/41SzwmCExGL._AC_UF894,1000_QL80_.jpg" style="width: 30%; height: 40%" class="imagen-product">
